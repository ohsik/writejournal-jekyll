...
> _Copyright 2019 [Dean Attali](https://deanattali.com)_
...
(Assuming you are on this page and logged into GitHub) Fork this repository by clicking the _Fork_ button on the top right corner. Forking means that you now copied this whole project and all the files into your account.

### 2. Rename the repository to `<yourusername>.github.io`

This will create a GitHub User page ready with the **Beautiful Jekyll** template that will be available at `https://<yourusername>.github.io` within a couple minutes. To do this, click on _Settings_ at the top (the cog icon) and there you'll have an option to rename.
...
After you save your changes to the config file (by clicking on _Commit changes_ as the video tutorial shows), your website should be ready in a minute or two at `https://<yourusername>.github.io`. Every time you make a change to any file, your website will get rebuilt and should be updated in about a minute or so.
